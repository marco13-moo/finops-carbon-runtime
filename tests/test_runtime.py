...
class RuntimeTests(unittest.TestCase):
    ...
    def test_shared_pool_reconciles_without_double_counting(self) -> None:
    ...
    def test_batch_deferral_never_applies_to_interactive_workloads(self) -> None:
        windows = [
    ...
    def test_multiple_pools_require_explicit_pool_and_reconcile_independently(self) -> None:
        pools = [
